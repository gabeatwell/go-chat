...
// ---------- DOM refs ----------
const messagesDiv = document.getElementById("messages") as HTMLElement | null;
...
const adminModal = document.getElementById("adminModal") as HTMLElement | null;
const adminPasswordInput = document.getElementById(
  "adminPassword",
) as HTMLInputElement | null;
const adminLoginBtn = document.getElementById(
  "adminLoginBtn",
) as HTMLButtonElement | null;
const adminCancelBtn = document.getElementById(
  "adminCancelBtn",
) as HTMLButtonElement | null;
const adminErrorMsg = document.getElementById(
  "adminErrorMsg",
) as HTMLElement | null;
...
const VAPID_PUBLIC_KEY =
  "BIRtPT_tN2Wfk0SqmgQhCMNxMZmVDmiNNQQ6oqxmOC0UQfLGckhFzKEyyA2ZtEljJ9druugMmPbUEJi1Z1FBtmk";
...
function showInstallDirections(): void {
...
function openAdminModal(): void {
  if (!adminModal || !adminErrorMsg || !adminPasswordInput) return;
...
function closeAdminModal(): void {
  if (!adminModal || !adminErrorMsg) return;
  adminModal.style.display = "none";
  adminErrorMsg.textContent = "";
}

async function handleAdminLogin(): Promise<void> {
  if (!adminPasswordInput || !adminErrorMsg) return;
...
function addMessage(user: string, text: string, isOwn: boolean): void {
...
function notifyMessage(user: string, text: string): void {
...
function sendMessage(): void {
  ...
  const payload: ChatMessage = { user: username, text };
